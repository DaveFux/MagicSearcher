                ...
                menuItem -> {
                    ...
                    switch (menuItem.getItemId()) {
                        case R.id.searchCards:
                            Intent intent = new Intent(HowToUseActivity.this, CollectionActivity.class);
                            Bundle b = new Bundle();
                        ...
                        case R.id.addCollection:
                            ...
                            break;
                        case R.id.settings:
                            startActivity(new Intent(HowToUseActivity.this, SettingsActivity.class));
                            break;
                        case R.id.aboutUs:
                            startActivity(new Intent(HowToUseActivity.this, AboutUsActivity.class));
                            break;
                        case R.id.howToUse:
